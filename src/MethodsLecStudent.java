...
//  METHODS
    ...
    public static void orderFood(String food) {
        System.out.println("I would like a " + food);
    }

    public static void orderFood(int amount, String item) {

        System.out.println("I would like " + amount + " orders of " + item + ".");
    ...
    public static void favoriteSong() {
        System.out.println("A House is not a Home by Luther Vandross");
    }
